...
- Runtime 到 Action Hands 使用 MCP revision `2025-11-25`、JSON-RPC over Streamable HTTP。
...
内部 MCP 固定 `2025-11-25` 基线并通过 `initialize` 协商 capability。第一阶段支持 `tools/list`、`tools/call`、
