...
> 配套文档：[MCP Runtime 能力平面](../architecture/system/23%20MCP%20Runtime%20能力平面.md)、[M9 实施与运维](../development/implementation/mcp-runtime.md)。Java 服务的接入步骤、测试和实现约束已统一收敛在本文。
