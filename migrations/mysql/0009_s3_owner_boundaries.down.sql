...
INSERT IGNORE INTO `security_tool_capability`
...
INSERT IGNORE INTO `security_tool_invocation_dedup`
...
INSERT IGNORE INTO `security_credential_reference`
...
INSERT IGNORE INTO `security_credential_usage_audit`
...
FROM `credential_usage_audit`
WHERE usage_id NOT LIKE 'legacy:%';

DROP TABLE IF EXISTS `artifact_admin_operation`;
DROP TABLE IF EXISTS `delivery_admin_operation`;
DROP TABLE IF EXISTS `projection_admin_operation`;
...
DROP INDEX IF EXISTS `session_core_outbox_claimable_idx`;
